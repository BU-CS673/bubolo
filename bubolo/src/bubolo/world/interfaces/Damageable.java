package bubolo.world.interfaces;


/**
 * Interface for Entities that are able to be affected by other objects through taking damage.
 * Outlines methods relating to getting, checking, and modifying the HP of Entities.
...
public interface Damageable
{
	...
	/**
	 * Modify this Damageable's HP by the specified amount.
	 * Positive values should increase the current HP, negative values should decrease it.
