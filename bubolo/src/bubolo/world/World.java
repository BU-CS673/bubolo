...
public interface World
{
     ...
     * @param controllerType the type of controller associated with the entity
	 */
	public <ET extends Entity, CT extends Controller> ET CreateAndAddEntity(Class<ET> entityType, Class<CT> controllerType);
