...
public abstract class Entity implements Serializable, Drawable
{
	...
	/**
	 * Set this Entity's controller.
	 * 
	 * @param controller
	 *            is the desired Entity Controller object.
	 * @return this Entity.
	 */
	public Entity setController(Controller c){
		this.controller = c;
		return this;
	}
	/**
	 * Get this Entity's Controller.
	 * 
	 * @return this Entity's controller object.
	 */
