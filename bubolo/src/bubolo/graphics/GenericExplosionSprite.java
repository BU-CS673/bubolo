...
class GenericExplosionSprite extends Sprite<Entity>
{
	 ...
	 * @param GenericExplosion Reference to the GenericExplosion that this GenericExplosionSprite represents.
	 */
	GenericExplosionSprite(GenericExplosion exp)
	{
		super(DrawLayer.EFFECTS, exp);

		frames = TextureUtil.splitFrames(Graphics.getTexture(Graphics.TEXTURE_PATH + "genericExplosion.png"),26,26);
	}
