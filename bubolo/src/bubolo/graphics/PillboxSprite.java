...
class PillboxSprite extends Sprite<Pillbox>
{
	...
	public void draw(SpriteBatch batch, Camera camera, DrawLayer layer)
	{
		...
		/**
		 * Get the current HP of this object and determine currentState currentState = 1
		 * is full health currentState = 0 to .99 represents percentage of total health
		 * available for Pillbox we have 3 appearances 100 = 5 99 - 75 = 4 74 - 50 = 3 49
		 * - 25 = 2 24 - 1 = 1 0 = 0 ("dead" for Pillbox is inactive, but still present on
		 * screen)
		 */
		...
		// int currentState = round(((getEntity().getHP() / getEntity().getMaxHP()) * 100)
		// / 20);
		 ...
		 * x,y,width,height Assuming our focus is on lower left... i.e. start at 0,32 and
		 * increase X as we move right?
		 */
		 ...
		 * specificImage); break; default: // Something has gone horribly wrong... I'm sad
